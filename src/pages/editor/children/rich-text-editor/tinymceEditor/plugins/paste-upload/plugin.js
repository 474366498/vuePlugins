  ...
  /******/ [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var plugin = function plugin(editor) {
        var loadingImage =
          '<img id="loadingImg" src="http://cos.qdqcwy.cn/group1/M00/00/00/rBHIsFtz4TSAJ1P0AAAUUF6elKk222.gif" alt="" />'
        ...
        function uploadFile(file, filename) {
          ...
          if (
            pasteUploadConfig.headers &&
            pasteUploadConfig.headers.length > 0
          ) {
            ...
            try {
              for (
                var _iterator = pasteUploadConfig.headers[Symbol.iterator](),
                  _step;
